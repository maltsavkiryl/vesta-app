const en = {
  ...
  planning: {
    ...
    repoUnavailable: "Planning repository not available.",
    errors: {
      accessDenied: "Access denied.",
      notFound: "Resource not found.",
      conflict: "This action conflicts with an existing state.",
      alreadyClaimed: "This call has already been claimed.",
      saveAvailabilityFailed: "Could not save availability.",
      usePlanningTools: "Use the planning tools to request a swap, change or time off.",
      noResponseNeeded: "This shift doesn't need a response.",
      windowsFromAvailability: "Planning windows are managed from the availability screen.",
      completeTodoFailed: "Could not complete todo.",
      uncompleteTodoFailed: "Could not uncomplete todo.",
      claimFailed: "Could not claim this call.",
      swapCreateFailed: "Could not create shift swap request.",
      swapDecideFailed: "Could not decide shift swap.",
      swapCancelFailed: "Could not cancel shift swap.",
      changeCreateFailed: "Could not create shift change request.",
    },
    sections: {
    ...
    requestCategories: {
      timeOffTitle: "Time off",
      timeOffDesc: "Request one or more days off",
      shiftChangeTitle: "Shift change",
      shiftChangeDesc: "Ask for help with a scheduled shift",
      availabilityIssueTitle: "Availability issue",
      availabilityIssueDesc: "Flag an availability conflict or exception",
    },
    reasonPresets: {
      personal: "Personal",
      medical: "Medical",
      ...
      classExam: "Class or exam",
      familyCommitment: "Family commitment",
      existingAppointment: "Existing appointment",
      unexpectedConflict: "Unexpected conflict",
    },
    availabilityStatus: {
      preferred: "Preferred",
      unavailableDesc: "Day off",
      availableDesc: "Can work if needed",
      preferredDesc: "Best day for me to work",
    },
    calls: {
      title: "Open Calls",
  ...
  auth: {
    ...
    errors: {
      ...
      sessionStartFailed: "Could not start a session for this employer.",
      noEmployerLinked: "No employer is linked to this account yet.",
      sessionExpired: "Your sign-in expired. Please sign in again.",
      verifyFailed: "We couldn't verify your identity. Please try again.",
    },
  },
  onboarding: {
  ...
  home: {
    ...
    topFocus: "Top focus",
    summary: {
      nextShift: "Next shift {{day}} at {{time}}",
      updatesWaiting: "{{count}} updates waiting",
      allClear: "You're clear for now",
    },
    derivedTasks: {
      uploadIdTitle: "Upload your ID card",
      uploadIdSubtitle: "Required before the next payroll run",
      uploadIdActionTitle: "ID card verification",
      upload: "Upload",
      reviewShiftTitle: "Review {{day}} shift update",
      reviewShiftSubtitle: "Your manager needs a response on this shift",
      review: "Review",
      setAvailabilityTitle: "Set availability for {{window}}",
      setAvailabilitySubtitle: "Help the team finalize rota planning",
      set: "Set",
    },
    cockpit: {
      viewShift: "View shift",
  ...
  time: {
    ...
    activeCard: {
      ...
      onBreak: "On break",
      working: "Working",
      checkedInAt: "Checked in at {{location}}",
      onShift: "On shift {{hours}} · {{venue}}",
      onBreakA11y: "On break {{hours}}",
      payableA11y: "Payable time {{hours}}",
      expandCard: "Expand time card",
      collapseCard: "Collapse time card",
    },
    startTimer: "Start timer",
    entryDetailTitle: "Entry details",
    clockIn: "Clock in",
    availableFrom: "Available from {{time}}",
    chooseWorkplacePrompt: "Choose the workplace for this timer.",
    noManualEmployer: "No linked employer currently allows timer starts without a scheduled shift.",
    ...
    capture: {
      ...
      photoRequired: "This workplace requires a photo to clock in.",
    },
    card: {
      setupNeeded: "Setup needed",
      manualDisabled: "Manual time tracking is not enabled for your linked workplaces",
      askEmployer: "Ask your employer to enable clock-ins without a scheduled shift.",
      onlyManual: "You can only start time from a workplace that allows manual clock-ins.",
      noWorkplaceReady: "No workplace ready",
      scheduledShift: "Scheduled shift",
      noShiftNeeded: "No scheduled shift is needed here.",
      trackUnscheduled: "Start tracking time even when you are not scheduled.",
      inGeofence: "In geofence",
      closestFirst: "Closest workplace is suggested first.",
      distanceAwayClosest: "{{distance}} away. Closest workplace is suggested first.",
      chooseThenTrack: "Choose a workplace, then start tracking time without a scheduled shift.",
    },
    errors: {
      ...
      breakStartFailed: "Could not start a break.",
      breakEndFailed: "Could not end the break.",
      clockOutFailed: "Could not clock out.",
    },
  },
  profile: {
    alerts: {
    ...
    appearance: {
      ...
      motionFull: "Full",
      currentSubtitle: "Current appearance",
      useSubtitle: "Use this appearance",
    },
    setup: {
      accountSetup: "Account setup",
      readyTitle: "Ready to work",
      readyBody: "Everything important is on file for shifts, payroll, and support.",
      almostTitle: "Almost ready",
      almostBody: "Finish the remaining setup details to keep your account ready.",
      basicsHint: "Complete your profile basics so the rest of your setup stays accurate.",
      linkWorkplaceHint: "Link a workplace before you start managing shifts and documents.",
      phoneHint: "Add your phone number so employers can reach you quickly about shifts.",
      addressHint: "Add your home address for payroll and official correspondence.",
      payrollHint: "Finish your payroll details so payouts and compliance stay on track.",
      emergencyHint: "Add an emergency contact so employers know who to call if needed.",
    },
    overview: {
    ...
    payrollGaps: {
      ...
      ssin: "National number (SSIN)",
      address: "Home address",
    },
    formError: "Something went wrong. Please try again.",
    settingsHelp: {
      clockingTitle: "Clocking in and out",
      clockingBody: "Use the Time tab to start work, begin breaks, and confirm clock-out totals.",
      documentsTitle: "Documents and payroll",
      documentsBody:
        "Use Legal documents, Contracts, and Payslips in Profile to manage your payroll paperwork.",
      schedulesTitle: "Schedules and availability",
      schedulesBody: "Use Schedule to review shifts, set availability, and request changes.",
    },
    security: {
      setupBiometricFirst:
      ...
      usePasscode: "Use passcode",
      biometricDevBuild: "Rebuild the development app to enable Face ID.",
    },
    support: {
      emailUnavailable: "Email unavailable",
      emailUnavailableBody: "Set up a mail app on this device to contact Vesta support.",
      helpBody: "I need help with the employee mobile app.",
      whatHappened: "What happened:",
      supportSubject: "Vesta mobile support request",
      problemBody: "I'm reporting a problem in the employee mobile app.",
      expectedBehavior: "Expected behavior:",
      actualBehavior: "Actual behavior:",
      stepsToReproduce: "Steps to reproduce:",
      problemSubject: "Vesta mobile problem report",
    },
    photo: {
      ...
      cameraNeeded: "Camera access needed",
      cameraNeededBody: "Allow camera access to take a profile photo.",
      photoNeeded: "Photo access needed",
      photoNeededBody: "Allow photo library access to choose a profile photo.",
      unavailable: "Photo unavailable",
      devBuild: "Rebuild the development app to enable profile photo changes.",
    },
    employerJoin: {
      enterCodeError: "Enter a 6-character code to continue.",
      noWorkplaceForCode: "No workplace found for this code.",
      enterCodeTab: "Enter a workplace code",
    ...
    sectionMeta: {
      ...
      privacyValue: "App diagnostics & sharing",
      supportValue: "Get help or contact Vesta",
      addressTitle: "Address",
      addressSubtitle: "The address used for official employment and payroll correspondence.",
      appearanceTitle: "Appearance",
      appearanceSubtitle: "Choose how Vesta should appear on this device.",
      bankingTitle: "Bank details",
      bankingSubtitle: "Payroll account and reimbursement details.",
      contactTitle: "Contact details",
      contactSubtitle: "How employers can reach you for urgent shift and payroll updates.",
      contractsTitle: "Contracts",
      employersTitle: "Employers",
      employersSubtitle: "Restaurants and workplaces linked to your Vesta profile.",
      legalDocumentsTitle: "Legal documents",
      joinEmployerTitle: "Add workplace",
      languageTitle: "Language",
      languageSubtitle: "Choose the language used throughout the app.",
      legalTitle: "Legal information",
      legalSubtitle: "Private identity details required for compliant employment.",
      personalTitle: "Personal details",
      personalSubtitle: "Names, profile basics, and employee identity.",
      payslipsTitle: "Payslips",
      preferencesTitle: "Notifications",
      preferencesSubtitle: "Choose how Vesta should notify you.",
      privacyTitle: "Privacy",
      privacySubtitle: "Control app analytics, diagnostics, and employer data sharing.",
      securityTitle: "Security",
      securitySubtitle: "Manage your password and device unlock settings.",
      changePasswordTitle: "Change password",
      changePasswordSubtitle: "Update the password used to sign in on this device.",
      supportTitle: "Help & support",
      supportSubtitle: "Find answers or contact Vesta support.",
    },
    overviewRows: {
      linkFirst: "Link your first workplace",
      linkedCount: "{{count}} linked",
      addPhone: "Add phone number",
      addAddress: "Add home address",
      addPayout: "Add payout account",
      finishPayroll: "Finish payroll details",
      passwordOnly: "Password only",
      passwordPlus: "Password + {{type}}",
  ...
  documents: {
    ...
    searchLegal: "Search legal documents...",
    searchContracts: "Search contracts...",
    searchPayslips: "Search payslips...",
    legalEmptyFiltered:
      "Try another search term or clear the filter to see every required document.",
    legalEmpty: "Anything that needs an upload or review will appear here.",
    contractsEmptyFiltered: "Try a different contract name or clear the search.",
  ...
  calendar: {
    ...
    setupFailed: "Vesta couldn't set up your calendar feed right now.",
    openFailed: "Vesta couldn't open your calendar feed.",
  },
  employers: {
